...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('upform_core_path', null, $modx->getOption('core_path') . 'components/upform/') . 'model/';
            $modx->addPackage('upform', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/upform/model/schema/upform.mysql.schema.xml';
